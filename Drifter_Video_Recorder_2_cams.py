...
while True:
    ...
    #DEFAULT_PIPELINE="v4l2src device=/dev/video1 ! videorate  ! image/jpeg,framerate=30/1,width=1920,height=1080 ! jpegparse ! avimux name=muxer ! filesink location=" + filename_str + ".avi"
    DEFAULT_PIPELINE="v4l2src device=/dev/video2 ! videorate  ! image/jpeg,framerate=30/1,width=1920,height=1080 ! jpegparse ! avimux name=muxer1 ! filesink location=" + right_filename_str + ".avi v4l2src device=/dev/video0 ! videorate  ! image/jpeg,framerate=30/1,width=1920,height=1080 ! jpegparse ! avimux name=muxer2 ! filesink location=" + left_filename_str + ".avi"
