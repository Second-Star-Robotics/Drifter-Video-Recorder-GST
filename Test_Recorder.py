...
DEFAULT_PIPELINE="v4l2src device=/dev/video2 ! video/x-h264, width=1920, height=1080, framerate=30/1, format=H264 ! splitmuxsink location=" + filename_str + "%05d.mp4 max-size-time=300000000000"
